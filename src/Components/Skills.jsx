...
const Skills = () => {
  return (
    <div name='skills' id="mainskill" className='w-full h-screen bg-[#0a192f] text-gray-300'>
      {/* Container */}
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
          <div>
              <p className='text-4xl font-bold inline border-b-4 border-pink-600 '>Skills</p>
              <br /> 
              <p    className='py-4'  id="skill1"  >Front End</p>
          ...
          <div className=' bg-[#0a192f]  w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              ...
              <p    className='py-4'  id="skill1"  >Back End</p>
